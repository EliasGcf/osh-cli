...
osh-cli/0.0.13 darwin-x64 node-v12.16.3
$ osh --help [COMMAND]
USAGE
  $ osh COMMAND
...
...
_See code: [src/commands/create/component.ts](https://github.com/EliasGcf/osh-cli/blob/v0.0.13/src/commands/create/component.ts)_
...
_See code: [src/commands/create/page.ts](https://github.com/EliasGcf/osh-cli/blob/v0.0.13/src/commands/create/page.ts)_
...
_See code: [src/commands/create/route.ts](https://github.com/EliasGcf/osh-cli/blob/v0.0.13/src/commands/create/route.ts)_
